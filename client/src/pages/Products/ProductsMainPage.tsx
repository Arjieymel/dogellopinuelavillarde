            ...
            <div className="min-h-[calc(100vh-5rem)]">
                <div className="rounded-2xl bg-linear-to-b from-blue-600/10 via-cyan-600/5 to-transparent border border-blue-200/60 p-5 sm:p-6 shadow-sm">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Product Management</h1>
                            <p className="text-sm text-gray-600 mt-1">Manage your water station products, pricing, and stock levels.</p>
                        </div>
                    </div>

                    {/* Table Card */}
                    <div className="mt-5 overflow-hidden rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-shadow p-5">

                        <div ref={tableRef} className="relative max-w-full max-h-[calc(100vh-12.5rem)] overflow-x-auto">
                            <Table>
                                <caption className="mb-4">
                                    <div className="border-b border-blue-200/70">
                                        <div className="p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                            ...
                                            <button
                                                type="button"
                                                className="w-full sm:w-auto px-4 py-2 bg-linear-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-medium rounded-lg shadow-lg transition cursor-pointer"
                                                onClick={openAdd}
                                            >
                                                Add Product
                                            </button>
